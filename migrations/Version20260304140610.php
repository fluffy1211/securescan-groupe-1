 ...
 */
final class Version20260304140610 extends AbstractMigration
{
    ...
    {
        // SQLite does not support ADD COLUMN NOT NULL without a default — use temp table
        ...
        $this->addSql('INSERT INTO user (id, email, roles, password) SELECT id, email, \'[]\', password FROM __temp__user');
